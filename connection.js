...
//     }
  ...
  const { roleOnExpand } = parseURLParams(window.location)
  console.log('parsed roleOnExpand as ' + roleOnExpand)

  if (roleOnExpand === 'listener') {
    id = 'listener@hidden.expand.app' // eslint-disable-line no-param-reassign
    password = 'listenerpass' // eslint-disable-line no-param-reassign
  }
